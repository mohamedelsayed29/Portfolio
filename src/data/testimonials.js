export const TESTIMONIALS = [
  {
    id: 'atlas',
    quote: {
      en: 'They shipped the retrieval pipeline three weeks early and then spent that time building the eval suite we did not know we needed. That is the whole relationship in one sentence.',
