    ...
    <div className="flex flex-col gap-5 lg:flex-row lg:items-center lg:justify-between">
      ...
      <div className="relative w-full lg:max-w-[280px]">
        ...
        <input
          ...
          placeholder="Search work or stack"
          aria-label="Search projects"
          className="h-11 w-full rounded-full border border-transparent bg-surface-muted pr-4 pl-11 text-[14px] transition-all duration-200 placeholder:text-text-subtle focus:border-accent focus:bg-surface focus:ring-4 focus:ring-accent/16 focus:outline-none"
        />
      </div>
    </div>
  )
